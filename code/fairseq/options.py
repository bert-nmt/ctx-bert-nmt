...
def add_dataset_args(parser, train=False, gen=False):
    ...
    # fmt: on
    # mine
    parser.add_argument('--do-not-sort-indices-by-size', default=False, action='store_true')
    return group
...
def add_optimization_args(parser):
    ...
    # fmt: on
    group.add_argument('--incremental-update', default=0, type=int,
                       help="stop training incremental_update steps after num_update from incremental_update_from")
    group.add_argument('--incremental-update-from', default=None)
    return group
