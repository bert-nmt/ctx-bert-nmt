# paras: hid, src, tgt, ctx, dropout, bsz, update_freq, attn_ddropout, pretrained model
ARCH=transformers2  # base model
...
SAVEDIR=/tmp/opensubtitle_enzh/${exp}/${src}-${tgt}_hid-${hid}_dropout-${dropout}_bsz-${bsz}_update-${update_freq}_attndropout-${attn_dropout}
